...
- **Notificação de documento pronto** — depende de aparelho registrado, o que só existe na E6 (decisão 12 da E4). **Resolvido de outro jeito** — a E6 dispensou o push: o aplicativo avisa do documento pronto ao abrir, conforme a [decisão 10 das decisões técnicas da E6](../06-app/decisoes-tecnicas.md#10-documento-pronto-é-aviso-ao-abrir-não-notificação-por-push).
